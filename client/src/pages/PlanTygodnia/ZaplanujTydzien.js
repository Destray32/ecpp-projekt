...
export default function ZaplanujTydzienPage() {
    ...
    const fetchPlany = useCallback(() => {
        ...
        Axios.get(`https://api-service-ecpp.onrender.com/api/planTygodnia/zaplanuj?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`,
    ...
    const handleZaplanuj = () => {
        ...
        Axios.post(`https://api-service-ecpp.onrender.com/api/planTygodnia/zaplanuj`, {
    ...
    const handleUsun = (planId) => {
        Axios.delete(`https://api-service-ecpp.onrender.com/api/planTygodnia/zaplanuj?id=${planId}`, { withCredentials: true })
            .then((response) => {
                fetchPlany();
            })
            .catch((error) => {
