...
export default function HomePage() {
    ...
    const handleLogout = async () => {
        try {
            await axios.post(`https://api-service-ecpp.onrender.com/api/logout`, {}, { withCredentials: true });
            navigate('/');
        } catch (error) {
            console.error(error);
        }
    ...
    const checkTokenValidity = async () => {
        try {
            await axios.get(`https://api-service-ecpp.onrender.com/api/check-token`, { withCredentials: true });
        } catch (error) {
    ...
    const daneUzupelnione = async () => {
        try {
            const response = await axios.get(`https://api-service-ecpp.onrender.com/api/dane-uzupelnione`, { withCredentials: true });
    ...
    const getBadgeCount = async () => {
        try {
            const response = await axios.get(`https://api-service-ecpp.onrender.com/api/ogloszenia/count`, { withCredentials: true });
    ...
    useEffect(() => { // useEffect ze względu na to żeby tata się zmieniała w razie potrzeby
        ...
        //     navigator.sendBeacon(`https://api-service-ecpp.onrender.com/api/zamkniecieStrony`);
        // };
