...
export default function OgloszeniaPage() {
    ...
    const fetchOgloszenia = () => {
        axios.get('https://localhost:5000/api/ogloszenia', { withCredentials: true })
            .then((response) => {
    ...
    const fetchPracownicy = () => {
        axios.get('https://localhost:5000/api/ogloszenia/pracownicy', { withCredentials: true })
            .then((response) => {
    ...
    const fetchGrupy = () => {
        axios.get('https://localhost:5000/api/ogloszenia/grupy', { withCredentials: true })
            .then((response) => {
    ...
    const handleOk = () => {
        form.validateFields().then((values) => {
            ...
            axios.post('https://localhost:5000/api/ogloszenia', postData, { withCredentials: true })
                .then(() => {
                    fetchOgloszenia();
    ...
    const handleDeleteOk = () => {
        if (itemToDelete) {
            axios.delete(`https://localhost:5000/api/ogloszenia/${itemToDelete}`, { withCredentials: true })
                .then(() => {
                    fetchOgloszenia();
    ...
    const markAsRead = (announcementId) => {
        axios.post('https://localhost:5000/api/ogloszenia/przeczytane', { idOgloszenia: announcementId }, { withCredentials: true })
          .then(response => {
