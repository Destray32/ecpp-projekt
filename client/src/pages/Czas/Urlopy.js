...
export default function UrlopyPage() {
    ...
    const handlePdfDownloadClick = () => {
        ...
        Axios.post(
            "https://localhost:5000/api/urlopy/pdf",
            ...
            .then((response) => {
                ...
                setTimeout(() => {
                    window.open(`https://qubis.pl:3000/test`, '_blank');
                }, 1500);
    ...
    const handleZatwierdzConfirm = () => {
        ...
        Axios.put("https://localhost:5000/api/urlopy", {
            ids: ids,
            status: "Zatwierdzone",
        }, { withCredentials: true })
            .then(() => {
    ...
    const fetchUrlopy = () => {
        Axios.get("https://localhost:5000/api/urlopy", { withCredentials: true })
            .then((response) => {
    ...
    const handleDodaj = () => {
        Axios.post("https://localhost:5000/api/urlopy", {
    ...
    const handleUsun = (itemId) => {
        Axios.delete("https://localhost:5000/api/urlopy", {
            withCredentials: true,
            data: { id: itemId }
        })
            .then(() => {
    ...
    const handleSave = (vacationId) => {
        Axios.put(`https://localhost:5000/api/urlopy/${vacationId}`, {
