...
export default function ProjektyPage() {
    ...
    const handleDelete = (id) => {
        Axios.delete(`https://api-service-ecpp.onrender.com/api/czas/usun?id=${id}`, { withCredentials: true })
            .then((response) => {
                fetchProjects();
            })
            .catch((error) => {
    ...
    const handleSzukaj = () => {
        Axios.get(`https://api-service-ecpp.onrender.com/api/czas/szukaj?group=${filtr}`, { withCredentials: true })
            .then((response) => {
    ...
    const handlePrzeniesAktyw = () => {
        Axios.put(`https://api-service-ecpp.onrender.com/api/czas/przeniesAkt`,
    ...
    const handlePrzeniesNieaktyw = () => {
        Axios.put(`https://api-service-ecpp.onrender.com/api/czas/przeniesNieakt`,
            { ids: selectedItems.map((id) => id) },
            { withCredentials: true }
        )
            .then((response) => {
