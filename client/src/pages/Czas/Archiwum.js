...
export default function ArchiwumPage() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`http://47.76.209.242:5000/api/czas/archiwum/${selectedOption}`, { withCredentials: true });
    ...
    const handleActionClick = async (record) => {
        try {
            await axios.post('http://47.76.209.242:5000/api/czas/archiwum/przywroc', {
