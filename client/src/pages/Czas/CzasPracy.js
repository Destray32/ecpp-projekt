...
export default function CzasPracyPage() {
    ...
    const fetchGrupaWTygodniu = async () => {
        ...
        const urlRequest = `https://localhost:5000/api/planTygodnia/zaplanuj?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
    ...
    const fetchBlockStatus = async () => {
        try {
            const response = await Axios.get("https://localhost:5000/api/czas/warnings", {
                withCredentials: true
            });
    ...
    const fetchUserId = async () => {
        try {
            await Axios.get("https://localhost:5000/api/pracownicy", { withCredentials: true })
                .then((response) => {
    ...
    const fetchZalogowanyUzytkownik = () => {
        Axios.get("https://localhost:5000/api/imie", { withCredentials: true })
            .then((response) => {
    ...
    const fetchPojazdy = () => {
        Axios.get("https://localhost:5000/api/pojazdy", { withCredentials: true })
            .then((response) => {
    ...
    const fetchPracownicy = () => {
        Axios.get("https://localhost:5000/api/pracownicy", { withCredentials: true })
            .then((response) => {
    ...
    const fetchFirmy = () => {
        Axios.get("https://localhost:5000/api/firmy", { withCredentials: true })
            .then((response) => {
    ...
    const fetchWorkHours = async (employeeName, date) => {
        try {
            ...
            const response = await Axios.get("https://localhost:5000/api/czas", {
                withCredentials: true,
                params: {
    ...
    const fetchAdditionalProjects = async (employeeName, date) => {
        try {
            ...
            const response = await Axios.get("https://localhost:5000/api/czas/projekty/dodane", {
                withCredentials: true,
                params: {
                    pracownikName: employeeName,
                    weekData: weekData,
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await Axios.post(`https://localhost:5000/api/czas`, {
    ...
    const handleZamknijTydzien = async () => {
        ...
        if (projectTotalHours !== totalHours) {
            ...
            try {
                ...
                fetchUserId();
                try {
                    const warning_response = await Axios.post("https://localhost:5000/api/czas/warnings", {
                ...
                const response = await Axios.delete("https://localhost:5000/api/tydzien", {
                    data: {
    ...
    const handleOtworzTydzien = async () => {
        try {
            fetchUserId();
            const response = await Axios.post("https://localhost:5000/api/tydzien", {
                tydzienRoku: getWeek(currentDate, { weekStartsOn: 1 }),
                pracownikId: currentUserId,
                year: currentDate.getFullYear(),
            }, { withCredentials: true });
