...
export default function CzasPracyPage() {
    ...
    const fetchGrupaWTygodniu = async () => {
        ...
        const urlRequest = `https://api-service-ecpp.onrender.com/api/planTygodnia/zaplanuj?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
    ...
    const fetchBlockStatus = async () => {
        try {
            const response = await Axios.get(`https://api-service-ecpp.onrender.com/api/czas/warnings`, {
                withCredentials: true
            });
    ...
    const fetchUserId = async () => {
        try {
            await Axios.get(`https://api-service-ecpp.onrender.com/api/pracownicy`, { withCredentials: true })
                .then((response) => {
    ...
    const fetchFirmy = () => {
        Axios.get(`https://api-service-ecpp.onrender.com/api/firmy`, { withCredentials: true })
            .then((response) => {
    ...
    const fetchWorkHours = async (employeeName, date) => {
        try {
            ...
            const response = await Axios.get(`https://api-service-ecpp.onrender.com/api/czas`, {
                withCredentials: true,
                params: {
    ...
    const fetchAdditionalProjects = async (employeeName, date) => {
        try {
            ...
            const response = await Axios.get(`https://api-service-ecpp.onrender.com/api/czas/projekty/dodane`, {
                withCredentials: true,
                params: {
                    pracownikName: employeeName,
                    weekData: weekData,
    ...
    const fetchStatusTygodnia = async () => {
        try {
            ...
            const response = await Axios.get(`https://api-service-ecpp.onrender.com/api/tydzien/${weekData}`, {
                withCredentials: true
            });
    ...
    const handleSave = async () => {
        ...
        try {
            const response = await Axios.post(`https://api-service-ecpp.onrender.com/api/czas`, {
    ...
    const handleZamknijTydzien = async () => {
        ...
        if (projectTotalHours !== totalHours) {
            ...
            try {
                ...
                fetchUserId();
                try {
                    const warning_response = await Axios.post(`https://api-service-ecpp.onrender.com/api/czas/warnings`, {
                ...
                const response = await Axios.delete(`https://api-service-ecpp.onrender.com/api/tydzien`, {
                    data: {
    ...
    const handleOtworzTydzien = async () => {
        try {
            fetchUserId();
            const response = await Axios.post(`https://api-service-ecpp.onrender.com/api/tydzien`, {
                tydzienRoku: getWeek(currentDate, { weekStartsOn: 1 }),
                pracownikId: currentUserId,
                year: currentDate.getFullYear(),
            }, { withCredentials: true });
