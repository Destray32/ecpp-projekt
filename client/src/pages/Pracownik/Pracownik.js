...
export default function PracownikPage() {
  ...
  const handleDelete = (id) => {
    axios.delete(`https://api-service-ecpp.onrender.com/api/pracownik/${id}`, { withCredentials: true })
      .then((response) => {
  ...
  const fetchFirms = async () => {
    try {
      const response = await axios.get(`https://api-service-ecpp.onrender.com/api/pracownik/firmy`, { withCredentials: true });
  ...
  const fetchGroups = async () => {
    try {
      const response = await axios.get(`https://api-service-ecpp.onrender.com/api/pracownik/grupy`, { withCredentials: true });
  ...
  const handleSave = async (id, field, value) => {
    try {
      await axios.put(
        `https://api-service-ecpp.onrender.com/api/pracownik/komorka/${id}`,
