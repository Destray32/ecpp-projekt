        ...
        const fetchData = async () => {
            try {
                const [pracownicyRes, firmyRes, zleceniodawcyRes, projektyRes, samochodyRes] = await Promise.all([
                    Axios.get("https://localhost:5000/api/pracownicy"),
                    Axios.get("https://localhost:5000/api/firmy"),
                    Axios.get("https://localhost:5000/api/grupy"),
                    Axios.get("https://localhost:5000/api/czas/projekty"),
                    Axios.get("https://localhost:5000/api/pojazdy")
                ]);
